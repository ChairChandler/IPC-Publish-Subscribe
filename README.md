# **IPC Publish Subscribe** ![travis](https://travis-ci.org/ChairChandler/IPC-Publish-Subscribe.svg?branch=master) ![linux](https://img.shields.io/badge/platform-linux-lightgrey) ![gnu](https://img.shields.io/badge/license-GPL-green)
